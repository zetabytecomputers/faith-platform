...
const app = express()
app.get('/favorites',(req,res)=>res.render('favorites',{page:'favorites'}));
app.use(require('./middlewares/locals-normalizer'));
...
app.get('/images', (req, res) => {
  res.locals.page = 'images';  const imageCats = ['nature','worship','service','scripture art','people','church life'];  res.render('images', { SITE, title: 'Image Library — Share Light', canonical: SITE + '/images', imageCats });});
require('./routes_mod')(app, getPool());app.listen(PORT, ()=> console.log("Server listening on " + PORT));
...
// (auto-added safe route for /favorites)
